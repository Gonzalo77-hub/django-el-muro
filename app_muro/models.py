...
class UserManager(models.Manager):
    ...
    def validador_basico(self, postData):
        ...
        if User.objects.filter(email=postData['email']).exists():
            errors['email_existe'] = "el email ya esta registrado"
...
class Comment(models.Model):
    ...
    user_c = models.ForeignKey(User, related_name="comments_user", on_delete=models.CASCADE)
...
""" class CommentManager(models.Manager):
    def validador_basico(self,postData):
       com = Comment.objects.get(id=postData)
       if com.created_at < """
